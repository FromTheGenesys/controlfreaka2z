        ...
        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-body"> 
                    ...
                    <div class="alert alert-primary border-primary font-lg">
                        <b class="font-weight-normal">Hello</b>
                    </div>                    
              ...
              <tbody>
                <tr>
                  <td class="text-center">
                    <div class="avatar">
                      <img src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>img/avatars/1.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>img/flags/USA.png" alt="USA" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <img src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>img/flags/Brazil.png" alt="Brazil" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <img src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>img/flags/India.png" alt="India" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <img src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>img/flags/France.png" alt="France" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <img src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>img/flags/Spain.png" alt="Spain" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <img src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>img/flags/Poland.png" alt="Poland" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
