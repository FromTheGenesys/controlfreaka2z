  ...
  <footer class="app-footer text-white font-sm" style="border: 1px solid #000; background-color: #000">
    <span>Copyright © <?php echo date('Y'); ?>. <a class="text-success" ref="https://www.cashngobahamas.com/" target="_BLANK">Cash N' Go</a></span>
    <span class="ml-auto font-sm">Developed by <a class="text-success " href="https://www.genesysnow.com/" target="_BLANK">Genesys Now. A Technology Company</a></span>
  </footer>
  ...
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/mvp.js"></script>  
  <script src="<?php echo gpConfig['URLPATH'] . gpConfig['ASSETS']; ?>js/controlfreak.js"></script>  
